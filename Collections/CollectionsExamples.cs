...
namespace Collections
{
    class CollectionsExamples
    {
        static void Main()
        {
            ...
            Collection<int> nums = new Collection<int>(); //дефинираме си нова колекция масив
            ...
            var stringNums = new Collection<string>("Petya Dimitrova");
            Console.WriteLine(stringNums);
            Console.WriteLine($"Count: {stringNums.Count}. Capacity: {stringNums.Capacity}");
            Console.WriteLine();

            nums.Add(80);
            Console.WriteLine("Added: 80");
            Console.WriteLine(nums);
            Console.WriteLine();
